...
** \return HAL Status
**/
__INLINE HAL_StatusTypeDef NONNULL_INLINE__ set_TIM_Interrupts(TIM_HandleTypeDef * pTim, const bool on) {
...
** \return HAL Status
**/
__INLINE HAL_StatusTypeDef NONNULL_INLINE__ deinit_TIM_Base(TIM_HandleTypeDef * pTim) {
...
** \return HAL Status
**/
HAL_StatusTypeDef NONNULL__ init_TIM_Base(TIM_HandleTypeDef * pTim, const uint32_t freq);
...
** \return HAL Status
**/
HAL_StatusTypeDef NONNULL__ set_TIM_Freq(TIM_HandleTypeDef * pTim, const uint32_t freq);
...
** \return HAL Status
**/
HAL_StatusTypeDef NONNULL__ init_PWM_Chan(TIM_HandleTypeDef * pTim, const uint32_t chan, const uint16_t freq);
...
** \return HAL Status
**/
__INLINE HAL_StatusTypeDef NONNULL_INLINE__ set_PWM_Output(TIM_HandleTypeDef * pTim, const uint32_t chan, const bool on) {
...
** \return HAL Status
**/
HAL_StatusTypeDef NONNULL__ set_PWM_Duty_Scaled(const TIM_HandleTypeDef * pTim, const uint32_t chan, const uint16_t duty, const uint16_t scale);
...
** \return HAL Status
**/
__INLINE HAL_StatusTypeDef NONNULL_INLINE__ set_PWM_Duty_Perc(const TIM_HandleTypeDef * pTim, const uint32_t chan, const uint16_t duty) {
...
** \return HAL Status
**/
__INLINE HAL_StatusTypeDef NONNULL_INLINE__ set_PWM_Duty_Word(const TIM_HandleTypeDef * pTim, const uint32_t chan, const uint16_t duty) {
...
** \return HAL Status
**/
__INLINE HAL_StatusTypeDef NONNULL_INLINE__ set_PWM_Duty_Byte(const TIM_HandleTypeDef * pTim, const uint32_t chan, const uint8_t duty) {
...
** \return Error code
**/
FctERR NONNULL__ logPWM_setPin(logicPWM * pPWM, GPIO_TypeDef * GPIOx, const uint16_t GPIO_Pin, const bool polarity);
...
** \return Error code
**/
FctERR NONNULL__ logPWM_setFreq(logicPWM * pPWM, TIM_HandleTypeDef * pTim, const uint16_t freq, uint16_t granularity);
...
** \return Error code
**/
FctERR NONNULL__ logPWM_setDuty(logicPWM * pPWM, const uint16_t val);
...
** \return Error code
**/
FctERR NONNULL__ logPWM_getFreq(uint16_t * freq, const logicPWM * pPWM);
...
** \return Error code
**/
FctERR NONNULL__ logPWM_getDutyCycle(float * duty, const logicPWM * pPWM);
...
** \param[in,out] pPWM - pointer to emulated PWM channel
**/
void NONNULL__ logPWM_handler(logicPWM * pPWM);
